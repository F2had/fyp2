...
const sendMail = (to, subject, content) => {
  return transporter
    .sendMail({
      to: to,
      // FIXME: remove cc 
      cc: 'wif180706@siswa.um.edu.my',
      from: 'schedulingfyp@gmail.com',
      subject: subject,
            ...
            <tbody>
              <tr>
                <td>
                  ...
                  <div>
                    <div style="background-color: #b5d7e8;">
                      <div class="layout one-col stack" style="margin: 0 auto; max-width: 600px; min-width: 320px; width: 320px; width: calc(28000% - 167400px); overflow-wrap: break-word; word-wrap: break-word; word-break: break-word;">
                        <div class="layout__inner" style="border-collapse: collapse; display: table; width: 100%;">
                          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-full-width" style="background-color: #b5d7e8;"><td class="layout__edges">&nbsp;</td><td style="width: 600px" class="w560"><![endif]-->
                          <div class="column" style="text-align: left; color: #94a4b0; font-size: 14px; line-height: 21px; font-family: sans-serif;">
                            ...
                            <div style="font-size: 12px; font-style: normal; font-weight: normal; line-height: 19px;" align="center">
                              <a style="text-decoration: underline; transition: opacity 0.1s ease-in; color: #1bc1b6;" href="">
                                <img style="border: 0; display: block; height: auto; width: 100%; max-width: 150px;" alt="logo" width="150" src="https://i.ibb.co/mNGBVfW/logo.png" />
                              </a>
                            </div>
                    ...
                    <div style="background-color: #5461bb;">
                      <div class="layout one-col stack" style="margin: 0 auto; max-width: 600px; min-width: 320px; width: 320px; width: calc(28000% - 167400px); overflow-wrap: break-word; word-wrap: break-word; word-break: break-word;">
                        <div class="layout__inner" style="border-collapse: collapse; display: table; width: 100%;">
                          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-full-width" style="background-color: #5461bb;"><td class="layout__edges">&nbsp;</td><td style="width: 600px" class="w560"><![endif]-->
                          <div class="column" style="text-align: left; color: #94a4b0; font-size: 14px; line-height: 21px; font-family: sans-serif;">
                            <div style="margin-left: 20px; margin-right: 20px;">
                          ...
                          <div class="column" style="text-align: left; color: #94a4b0; font-size: 14px; line-height: 21px; font-family: sans-serif;">
                            ...
                            <div style="margin-left: 20px; margin-right: 20px;">
                              <div style="mso-line-height-rule: exactly; mso-text-raise: 11px; vertical-align: middle;">
                                <h1
                                  class="size-32"
                                  style="margin-top: 0; margin-bottom: 20px; font-style: normal; font-weight: normal; color: #fff; font-size: 28px; line-height: 36px; font-family: sans-serif; text-align: center;"
                                  lang="x-size-32"
                                >
                                  <span class="font-sans-serif">
                                    <span style="color: #000000;"><strong>${subject}</strong></span>
                                  </span>
                                </h1>
                              </div>
                            </div>
                            ...
                            <div style="margin-left: 20px; margin-right: 20px;">
                              <div style="mso-line-height-rule: exactly; mso-text-raise: 11px; vertical-align: middle;">
                                <p class="size-16" style="margin-top: 0; margin-bottom: 0; color: #000000; font-size: 16px; line-height: 24px; text-align: center;" lang="x-size-16">${content}</p>
                                <p class="size-16" style="margin-top: 20px; margin-bottom: 20px; font-size: 16px; line-height: 24px; text-align: center;" lang="x-size-16"><span style="color: #000000;"></span></p>
                              </div>
                            </div>
                      ...
                      >
                        <div class="layout__inner" style="border-collapse: collapse; display: table; width: 100%; background-color: #ffffff;">
                          ...
                          <div class="column" style="text-align: left; color: #94a4b0; font-size: 14px; line-height: 21px; font-family: sans-serif;">
                            ...
                            <div style="margin-left: 20px; margin-right: 20px;">
                              <div style="mso-line-height-rule: exactly; mso-text-raise: 11px; vertical-align: middle;">
                                <p class="size-15" style="margin-top: 0; margin-bottom: 0; font-family: roboto, tahoma, sans-serif; font-size: 15px; line-height: 23px; text-align: center;" lang="x-size-15">
                                  <span class="font-roboto">
                                    <strong><font color="#000000">Copyright</font></strong>
                                  </span>
                                </p>
                              </div>
                            </div>
                    ...
                    <div role="contentinfo">
                      <div class="layout email-footer stack" style="margin: 0 auto; max-width: 600px; min-width: 320px; width: 320px; width: calc(28000% - 167400px); overflow-wrap: break-word; word-wrap: break-word; word-break: break-word;">
                        <div class="layout__inner" style="border-collapse: collapse; display: table; width: 100%;">
                          ...
                          <div
                            class="column wide"
                            style="text-align: left; font-size: 12px; line-height: 19px; color: #94a4b0; font-family: sans-serif; float: left; max-width: 400px; min-width: 320px; width: 320px; width: calc(8000% - 47600px);"
                          >
                          ...
                          <div
                            class="column narrow"
                            style="text-align: left; font-size: 12px; line-height: 19px; color: #94a4b0; font-family: sans-serif; float: left; max-width: 320px; min-width: 200px; width: 320px; width: calc(72200px - 12000%);"
                          ></div>
                        </div>
                        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                      </div>
